...
splits = filter(lambda f: not f.startswith('.'), os.listdir(
    args.fold_A))  # ignore hidden folders like .DS_Store
...
for sp in splits:
    ...
    img_list = filter(
        ...
        os.listdir(img_fold_A))  # ignore hidden folders like .DS_Store
